        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="accountSettings.php" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Change Account Settings</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid" height="auto">
                ...
                <div class="row" height="auto">
                    <div class="col" height="auto">
                        <iframe src="accSettingsIframe.php" id="frame1" name="frame1" width="100%" height="auto" frameBorder=0 scrolling="no" onload="resizeIframe(this)"></iframe>
                    </div>
        </section>
