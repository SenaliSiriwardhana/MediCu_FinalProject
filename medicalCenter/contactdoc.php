    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="patientDashboard.php" class="brand-link">
                ...
                <span style="margin-left:10px" class="brand-text font-weight-light">Medico</span>
            </a>
            ...
            <div class="container-fluid" height="auto">
                ...
                <div class="row" height="auto">
                    <div class="col" height="auto">
                        <iframe src="emailsend.php" id="frame1" name="frame1" width="100%" height="auto" frameBorder=0 scrolling="no" onload="resizeIframe(this)"></iframe>
                    </div>
        </section>
