...
<head>
    ...
    <title>Lab Location in Maps</title>
    <style>
    ...
    <script>
        ...
        function searchLocationsNear(position) {
            ...
            var mylocation = new google.maps.LatLng(
                parseFloat(position.coords.latitude.toFixed(6)), // position.coords.latitude.toFixed(6)
            ...
            var radius = 100;
            var searchUrl = 'labmarkers.php?lat=' + position.coords.latitude.toFixed(6) + '&lng=' + position.coords.longitude.toFixed(6) + '&radius=' + radius; /*  position.coords.latitude.toFixed(6)  position.coords.longitude.toFixed(6)   */
