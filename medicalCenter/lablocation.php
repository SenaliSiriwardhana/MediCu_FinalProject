        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="lablocation.php" class="nav-link active">
                            <i class=" nav-icon fas fa-map-marked-alt"></i>
                            <p>
                                Search Nearest Lab
                            </p>
            ...
            <div class="container-fluid" height="auto">
                ...
                <div class="row" height="100%">
                    <div class="col" height="100%">
                        <iframe id="frame1" src="map2.php" name="frame1" width="100%" height="800px" frameBorder=0 scrolling="no" onload="resizeIframe(this)"></iframe>
                    </div>
        </section>
